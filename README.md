...
| La VPN funciona a algunes xarxes i a unes altres no | Algunes xarxes (eduroam) bloquejen el trafic `UDP`. Canvia el `ListeningPort` de `51820` -> `443` tant al client com al servidor |
